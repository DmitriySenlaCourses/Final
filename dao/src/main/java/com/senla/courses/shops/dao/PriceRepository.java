...
public interface PriceRepository extends JpaRepository<Price, Long> {
    List<Price> findByProductAndShopsAndDateBetween(Product product, Shop shop, LocalDate start, LocalDate end, Pageable pageable);
    ...
    List<PriceShop> getLastPrices(Long productId, Pageable pageable);
